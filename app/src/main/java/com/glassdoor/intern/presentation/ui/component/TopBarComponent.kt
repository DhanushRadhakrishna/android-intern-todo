...
private fun TopBarComponentPreview(
    ...
    /**
     *DONE TODO: Define a component and use the state to preview it
     */
    TopBarComponent(isLoading=isLoading, progressClickAction = {})
}

private class TopBarComponentPreviewParameterProvider :
    PreviewParameterProvider<Boolean> by previewParameterProviderOf(
//       DONE TODO("Define all possible states for preview purposes")
